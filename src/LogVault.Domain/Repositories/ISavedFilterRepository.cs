...
public interface ISavedFilterRepository
{
    ...
    Task<IReadOnlyList<SavedFilter>> GetAllAccessibleAsync(string ownerId, CancellationToken ct = default);
    Task<IReadOnlyList<SavedFilter>> GetAllAsync(CancellationToken ct = default);
